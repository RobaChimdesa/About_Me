    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <motion.h2
          ...
          className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-cyan-500 mb-8"
        >
          Database Skills
        </motion.h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 sm:gap-8 md:gap-10">
          {database.map((item, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 sm:p-5 flex flex-col items-center justify-center transition-all duration-500 hover:bg-gradient-to-br hover:from-teal-500 hover:to-cyan-500 dark:hover:from-gray-700 dark:hover:to-gray-600 hover:shadow-xl hover:text-white"
            >
              <img
                src={item.title}
                alt={item.name}
