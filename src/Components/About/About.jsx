    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            <p className="text-gray-700 dark:text-gray-300 text-base sm:text-lg md:text-xl leading-relaxed text-center md:text-left animate-fade-in">
            I'm Roba Chimdesa, a recent Computer Science and Engineering graduate from Adama Science and Technology University. I specialize in <span className="text-blue-600 dark:text-blue-400 font-semibold">web development</span> and am passionate about building<span className="text-blue-600 dark:text-blue-400 font-semibold"> innovative digital solutions</span>, constantly honing my skills to build innovative solutions.
            </p> 


            {showMore && (
              <p className="text-gray-700 dark:text-gray-300 text-base sm:text-lg md:text-xl leading-relaxed text-center md:text-left animate-fade-in-up">
               As a motivated problem-solver, I enjoy transforming complex challenges into efficient, user-friendly applications using modern technologies.
              </p>
            )}
            <button
              onClick={handleShow}
